...
public:
  ...
  RC create_view_alias(const char *view_name, const char *base_table_name);
  RC create_view_alias(const char *view_name, const char *base_table_name, const std::vector<std::string> &columns);
  RC create_view_alias(const char *view_name, const char *base_table_name,
