...
insert into Update_select_t2 VALUES (9, 'ZZ', 7, 8);
-- multi-column update with WHERE
UPDATE Update_select_t1 SET t_name='9UBT4J5', col2=2 WHERE id=5;
SELECT * FROM Update_select_t1;
-- single column update (regression)
UPDATE Update_select_t1 SET col1=99 WHERE id=2;
SELECT * FROM Update_select_t1;
-- update with scalar subquery
UPDATE Update_select_t1 SET col1=(select max(col1) from Update_select_t2) WHERE id=1;
SELECT * FROM Update_select_t1;
exit;
